...
namespace WebcamCalculator.Model
{
    public static class fastDetector
    {
        ...
        {
            Emgu.CV.Features2D.FastDetector fastDetector = new Emgu.CV.Features2D.FastDetector();
            ...
            fastDetector.DetectAndCompute(observedImage, null, templateKeyPoints, templateDescriptor, false);
            fastDetector.DetectAndCompute(templateImage, null, observedKeyPoints, observedDescriptor, false);
